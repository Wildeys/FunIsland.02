                ...
                <div class="p-6 text-gray-900">
                    @if($tickets->isEmpty())
                        <div class="text-center py-8">
                            <h3 class="text-lg font-medium text-gray-900 mb-2">No Ferry Tickets Found</h3>
                            <p class="text-gray-600 mb-4">You haven't booked any ferry tickets yet.</p>
                            <a href="{{ route('ferries.browse') }}" 
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($tickets as $ticket)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $ticket->ferrySchedule->date->format('M d, Y') }} <br>
                                                <span class="text-xs">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <a href="{{ route('ferries.tickets.show', $ticket) }}" 
