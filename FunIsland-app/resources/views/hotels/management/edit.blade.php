<x-management-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Hotel: {{ $hotel->name }}</h1>
                <p class="text-sm text-gray-600">Update hotel information and settings</p>
            </div>
    ...
    <div class="p-6">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow rounded-lg">
                ...
                <form method="POST" action="{{ route('hotels.update', $hotel) }}" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="price_per_night" name="price_per_night" type="number" 
                                         ...
                                         class="mt-1 block w-full" :value="old('price_per_night', $hotel->price_per_night)" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="contact_website" name="contact_info[website]" type="url" 
                                             class="mt-1 block w-full" 
                                             :value="old('contact_info.website', $hotel->contact_info['website'] ?? '')" 
            ...
            <div class="bg-white shadow rounded-lg mt-6">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h4 class="text-sm font-medium text-red-900">Delete Hotel</h4>
                            <p class="text-sm text-red-600">This action cannot be undone. All hotel data will be permanently deleted.</p>
                        </div>
